...
def model_fn(features, labels, mode):
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
        ...
        optimizer = tf.compat.v1.train.MomentumOptimizer(learning_rate=learning_rate, momentum=_MOMENTUM)
...
def make_batch(data_dir, batch_size=2):
    ...
    dataset = tf.compat.v1.data.TFRecordDataset(data_dir).repeat()
